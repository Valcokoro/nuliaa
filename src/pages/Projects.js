        ...
        <section className='projects'>
            ...
            <div className='flex-container'>
                <div className='item'>
                    ...
                    <img src={pbi1} className='pbi-pics1'/>
                    <img src={pbi2} className='pbi-pics2'/>
                ...
                <div className='flex-item'>
                    ...
                    <img src={rpics6} className='r-pics6' />
                    ...
                    <img src={rpics7} className='r-pics7' />
